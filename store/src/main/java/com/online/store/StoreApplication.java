...
public class StoreApplication {
	...
	/**
	 * Populates the H2 in-memory database with data for testing and development
	 * purposes
	 */
	...
	private void addProductCategories(ProductCategoryRepository repository) {
		...
		repository.saveAll(categories.stream().map(c -> new ProductCategories(c)).collect(Collectors.toList()));
	}
}
